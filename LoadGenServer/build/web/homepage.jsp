...
//                response.setIntHeader("refresh", 0); // refresh in every 5 seconds
            ...
            <tr><td><h3 class="heading">List Of Connected Clients</h3></td><td>
                ...
                <td>
                    <form action="homepage.jsp" method="post">
                        <input type="submit" class='button1'  formtarget="myframe" name="clearclientlist" value="Clear Connections">
                    </form>
                </td>
            </tr>
        </table>
        ...
        <%//            out.write("<h3>List Of Connected Clients</h3>");
                ...
                out.write("<tr><th>Mac Address</th><th>SSID</th><th>BSSID</th><th>Last HeartBeat</th><th>Connection Status</th></tr>");
                ...
                while (macList.hasMoreElements()) {
                    ...
                    if (activeClient.contains(device)) {
                        out.write("<tr><td>" + macAddr + "</td><td>" + device.getSsid() + "</td><td>" + device.getBssid() + "</td><td>" + device.getLastHeartBeatTime() + "</td><td><b style='color:green'>Active</b></td></tr>");
                    } else {
                        out.write("<tr><td>" + macAddr + "</td><td>" + device.getSsid() + "</td><td>" + device.getBssid() + "</td><td>" + device.getLastHeartBeatTime() + "</td><td><b style='color:red'>Passive</b></td></tr>");
                    }
